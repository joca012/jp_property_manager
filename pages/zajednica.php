...
<section class="grid grid-3" style="margin-top:18px">
    ...
    <a class="card module-card" href="index.php?page=elementi_zgrade_pregled&sz_id=<?= $szId ?>"><div><h3>Oprema</h3><p class="muted">Liftovi, hidranti, PP oprema, grejanje i druga oprema.</p></div><div class="icon">🔧</div></a>
